...
VERSION = "v0.3.4"   # bump this before every release
...
REPAIR_WORKSTATION_COST = (1000,  700,  500,   0,   0)  # 破銅×1000 爛鐵×700 鐵×500   (~3天 @20k點/天 連打模式)
REPAIR_WORKSTATION_HITS = 5000                          # click/key presses to complete
REPAIR_SHOP_COST        = (   0,    0, 1100, 380, 170)  # 鐵×1100 鋼×380 精金×170   (~7天 @20k點/天 連打模式)
