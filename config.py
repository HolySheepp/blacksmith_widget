...
VERSION = "v0.5.10"   # bump this before every release
...
# 梯度說明：暗紅 → 橙 → 琥珀 → 暖金黃 → 近白熱 → 藍白（越藍越高溫，符合玩家直覺）
CHARGE_COLORS = [
    ...
    (0xff, 0xcc, 0x60),   #  8  warm golden-yellow (between amber and white-hot)
    (0xff, 0xf0, 0xc0),   #  9  pale warm white (near white-hot)
